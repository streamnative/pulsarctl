...
func createFunctionsCmd(vc *cmdutils.VerbCmd) {
	...
	createWithLogTopic := common.Example{
	...
	createWithDeadLetterTopic := common.Example{
	...
	createWithAutoAck := common.Example{
	...
	createWithTopicsPattern := common.Example{
	...
	createWithUserConfig := common.Example{
	...
	createWithRetainOrdering := common.Example{
	...
	createWithCustomSchemasInputs := common.Example{
	...
	createWithWindowFunctions := common.Example{
