...
func Command(flagGrouping *cmdutils.FlagGrouping) *cobra.Command {
	...
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, getBundles)
	...
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, getDeduplication)
	...
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, GetEncryptionRequiredCmd)
	...
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, GetSubscriptionAuthModeCmd)
