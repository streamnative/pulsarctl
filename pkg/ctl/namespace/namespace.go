...
func Command(flagGrouping *cmdutils.FlagGrouping) *cobra.Command {
	...
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, removeRetention)
	...
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, GetSchemaAutoUpdateStrategyCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, SetOffloadDeletionLagCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, GetOffloadDeletionLagCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, ClearOffloadDeletionLagCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, SetOffloadThresholdCmd)
	...
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, removePersistence)
	...
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, GetMaxTopicsPerNamespaceCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, SetMaxTopicsPerNamespaceCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, RemoveMaxTopicsPerNamespaceCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, GetSubscriptionExpirationTimeCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, SetSubscriptionExpirationTimeCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, RemoveSubscriptionExpirationTimeCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, GetBookieAffinityGroupCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, SetBookieAffinityGroupCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, DeleteBookieAffinityGroupCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, GetSchemaCompatibilityStrategyCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, SetSchemaCompatibilityStrategyCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, GetPropertiesCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, SetPropertiesCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, ClearPropertiesCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, GetPropertyCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, SetPropertyCmd)
	cmdutils.AddVerbCmd(flagGrouping, resourceCmd, RemovePropertyCmd)
	return resourceCmd
}
