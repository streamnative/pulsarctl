...
func TestNsIsolationPolicyCommands(newVerb func(cmd *cmdutils.VerbCmd), args []string) (out *bytes.Buffer,
	...
	rootCmd.SetOut(buf)
	rootCmd.SetArgs(append([]string{"ns-isolation-policy"}, args...))
