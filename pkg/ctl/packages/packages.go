...
func Command(flagGrouping *cmdutils.FlagGrouping) *cobra.Command {
	...
	cmdutils.AddVerbCmds(flagGrouping, resourceCmd, listPackagesCmd)
	cmdutils.AddVerbCmds(flagGrouping, resourceCmd, listPackageVersionsCmd)
	cmdutils.AddVerbCmds(flagGrouping, resourceCmd, deletePackagesCmd)
