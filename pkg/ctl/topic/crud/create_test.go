...
func TestCreateTopicCmd(t *testing.T) {
	...
	_, execErr, argsErr, err := test.TestTopicCommands(CreateTopicCmd, args)
...
func TestCreateTopicAlreadExists(t *testing.T) {
	...
	_, _, _, err := test.TestTopicCommands(CreateTopicCmd, args)
	assert.Nil(t, err)
...
func TestCreateTopicArgsError(t *testing.T) {
	...
	_, _, nameErr, _ := test.TestTopicCommands(CreateTopicCmd, args)
