...
readonly PULSAR_DEFAULT_VERSION="2.11.1.2-arrowstreet"
...
case ${1} in
    ...
    tls)
        ...
        ;;
    function)
        docker run --name function --rm -e TEST_ARGS=function -e PULSAR_STANDALONE_USE_ZOOKEEPER=1 -e FUNCTION_ENABLE=true ${IMAGE_NAME}
        ;;
    sink)
