...
var GenPulsarctlDir = flag.String("gen-pulsarctl-dir", "site/gen-pulsarctldocs/generators", "Directory containing pulsarctl files")
...
func GenerateFiles() {
    ...
    manifest.Copyright = "<a href=\"https://github.com/streamnative/pulsarctl\">Copyright 2019 The Pulsarctl Authors.</a>"
...
func FormatDescription(input string) string {
    ...
    for _, line := range strings.Split(input, "\n") {
        ...
        if strings.HasPrefix(line, "USED FOR:") {
            line = "### " + "Used For" + "\n"
            result = append(result, line)
        } else if strings.HasPrefix(line, "REQUIRED PERMISSION:") {
            line = "\n" + "### " + "Required Permission" + "\n"
            result = append(result, line)
